...
const metasAbertas = async () => {
    ...
    if(abertas.length == 0){
        mnsagem = "Não existem metas abertas! :)"
        return
    }
...
const deletarMetas = async () => {
    ...
    const itensADeletar = await checkbox({
        message: "Selecione item para deletar. Use as setas para mudar de meta, o Space para marcar ou desmarcar e o Enter para finalizar essa etapa.",
